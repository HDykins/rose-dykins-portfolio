var Model = (function initModel() {
	...
	var articlesArray = [
		{pdf: true, link: "https://www.docdroid.net/jSYggMq/copenhagen-hygge.pdf.html", 'image-src': "./build/images/copenhagen-hygge.jpg", description: "The Danish capital combines business and pleasure with aplomb. Is Copenhagen's progressive attitude at the heart of it's success?", title: "The Hygge Life", "publication": "Business Traveller"},
		{pdf: true, link: "https://www.docdroid.net/zwsTSMC/humanlibrarynorwegian.pdf.html", 'image-src': "./build/images/human-library.jpg", description: "The Human Library's premise is simple but powerful: borrow a human 'Book' for 30 minutes, and ask them questions about their lives. The idea is that by examining them, Reader can learn about their own prejudices.", title: "The Human Library", "publication": "n by Norwegian"},
