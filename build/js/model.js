var Model = (function initModel() {
	...
	var articlesArray = [
		{pdf: true, link: "https://www.docdroid.net/jSYggMq/copenhagen-hygge.pdf.html", 'image-src': "./build/images/copenhagen-hygge.jpg", description: "The Danish capital combines business and pleasure with aplomb. Is Copenhagen's progressive attitude at the heart of it's success?", title: "Business and pleasure in Copenhagen", "publication": "Business Traveller"},
		{pdf: true, link: "https://www.docdroid.net/zwsTSMC/humanlibrarynorwegian.pdf.html", 'image-src': "./build/images/human-library.jpg", description: "The Human Library's premise is simple but powerful: borrow a human 'Book' for 30 minutes, and ask them questions about their lives. The idea is that by examining them, Reader can learn abour their own prejudices.", title: "In Copenhagen you can borrow people instead of books.", "publication": "n by Norwegian"},
		...
		{pdf: true, link: "https://www.docdroid.net/35PlzIn/nbynorwegianshed.pdf.html", 'image-src': "./build/images/shed-not-a-shed.png", description: "When it’s a SHED, one of London’s new flat-pack microhomes. Find out why these tiny houses make a lot of sense", title: "When is a shed not a shed?", "publication": "n by Norwegian"},
		{pdf: true, link: "https://www.docdroid.net/4isfDeV/nbynorwegiandodsing.pdf.html", 'image-src': "./build/images/belly-flop.png", description: "Imagine launching yourself off a 10m-high diving platform, pulling some serious shapes on the way down, before curling up into a ball and hitting the water’s surface at high speed. In the unlikely event that sounds like fun, then Døds might be for you.", title: "How do you make a successful flop?", "publication": "n by Norwegian"},
		{pdf: true, link: "https://www.docdroid.net/LoED5Hv/048-dusseldorf.pdf.html", 'image-src': "./build/images/fashion-forward.png", description: "Dusseldorf's thriving fashion industry has blossomed thanks to the city's avant garde art roots", title: "Fashion Forward", "publication": "Elevate"},
		{pdf: true, link: "https://www.docdroid.net/ilOX42f/lublin.pdf.html", 'image-src': "./build/images/lublin.png", description: "The inventive polish city plans to become a next-generation automotive hub", title: "Lublin's long game", "publication": "Elevate"},
		...
		{pdf: true, link: "https://www.docdroid.net/5Zb3qY7/bintan.pdf.html", 'image-src': "./build/images/bintan-bliss.png", description: "The lesser-known Indonesian island of Bintan has all the key ingredients for a high-end, hedonistic honeymoon", title: "Bintan bliss", "publication": "Destinations Weddings and Honeymoons Abroad"},
		...
		{pdf: true, link: "https://www.docdroid.net/mWJUmgo/jakarta.pdf.html", 'image-src': "./build/images/jakarta-traffic.png", description: "Jakarta’s chaotic traffic is symptomatic of a city whose infrastructure currently cannot cope with the demands of the many who want to feed off its enormous potential. Fortunately, change is on its way", title: "Out of the slow lane", "publication": "Business Traveller"},
		{pdf: true, link: "https://www.docdroid.net/0SPskT9/mauritius.pdf.html", 'image-src': "./build/images/mauritius.png", description: "Decided to take the plunge and elope to Mauritius? Rose Dykins explores settings for intimate weddings and unforgettable honeymoons at opposite ends of the island", title: "Mauritius - North and South", "publication": "Destinations Weddings and Honeymoons Abroad"},
		...
		{pdf: true, link: "https://www.docdroid.net/832bBsK/084-weekend-istanbul.pdf.html", 'image-src': "./build/images/instanbul-shadow-towers.jpg", description: "Successive historical influences make the largest city in Turkey a fascinating destination. Situated where east meets west, Istanbul’s alluring architecture and air of mysticism make it unlike any other city.", title: "Weekend in Istanbul", "publication": "Business Traveller"},
		{pdf: true, link: "https://www.docdroid.net/saGCyqt/077-escape-santorini.pdf.html", 'image-src': "./build/images/santorini.jpg", description: "The curious landscape and glorious skies of the volcanic Greek island is mesmerising", title: "Under the setting sun", "publication": "Business Traveller"},
		{pdf: true, link: "https://www.docdroid.net/6h4L9wC/031-hostels.pdf.html", 'image-src': "./build/images/hostel-furniture.png", description: "Is the new breed of upmarket hostels a viable option for budget business travellers?  People are increasingly turning to hostels for business stays – but not the kind of hostels you will remember.", title: "Bunking down", "publication": "Business Traveller"},
		{pdf: true, link: "https://www.docdroid.net/TczSwaj/028-luggage.pdf.html", 'image-src': "./build/images/luggage.jpg", description: "What is the aviation industry doing to stop luggage getting lost in the system?", title: "Handle with care", "publication": "Business Traveller"},
		{pdf: true, link: "https://www.docdroid.net/ZzzZAEz/031-security.pdf.html", 'image-src': "./build/images/security-swat.jpg", description: "As growth in emerging markets takes travellers to less developed places, Rose Dykins asks what assistance is available to help you stay safe", title: "Risky business", "publication": "Business Traveller"},
		{pdf: true, link: "https://www.docdroid.net/VtSezVN/034-ancillary-charges.pdf.html", 'image-src': "./build/images/ancillary.png", description: "Rose Dykins investigates how airline ancillary fees have changed the face of European aviation – and are no longer the reserve of low-cost carriers", title: "Ancillary charges - Strings attached", "publication": "Business Traveller"},
		...
		{pdf: true, link: "https://www.docdroid.net/IOSso7Y/biz-prague-2-1.pdf.html", 'image-src': "./build/images/biz-prague.jpg", description: "The Czech capital is working hard to boost foreign investment and show the world that it is not just a pretty face.", title: "Tech Republic", "publication": "Business Traveller"},
		{pdf: true, link: "https://www.docdroid.net/mHI8Mym/in-flight-dining.pdf.html", 'image-src': "./build/images/in-flight-dining.png", description: "In the battle of the skies, airlines are using their in-flight food to stand out from the competition. Rose Dykins reports on what’s being served up.", title: "What's cooking?", "publication": "Business Traveller"}
	];
