var Model = (function initModel() {
	...
	var articlesArray = [
		{pdf: false, link: "https://issuu.com/squareupmedia/docs/e41/42", 'image-src': "./build/images/big-reveal.png", description: "Would you book a holiday without knowing where you are going? Try the new trend of surprise travel", title: "The Big Reveal", "publication": "Escapism Magazine"},
		{pdf: false, link: "https://www.docdroid.net/35PlzIn/nbynorwegianshed.pdf.html", 'image-src': "./build/images/shed-not-a-shed.png", description: "When it’s a SHED, one of London’s new flat-pack microhomes. Find out why these tiny houses make a lot of sense", title: "When is a shed not a shed?", "publication": "n by Norwegian"},
		...
		{pdf: false, link: "https://www.docdroid.net/LoED5Hv/048-dusseldorf.pdf.html", 'image-src': "./build/images/fashion-forward.png", description: "Dusseldorf's thriving fashion industry has blossomed thanks to the city's avant garde art roots", title: "Fashion Forward", "publication": "flybmi.com"},
		{pdf: false, link: "https://www.docdroid.net/ilOX42f/lublin.pdf.html", 'image-src': "./build/images/lublin.png", description: "The inventive polish city plans to become a next-generation automotive hub", title: "Lublin's long game", "publication": "flybmi.com"},
